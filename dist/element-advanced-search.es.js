import { defineComponent as xe, ref as A, watch as ee, nextTick as B, computed as O, onMounted as ke, resolveComponent as p, createElementBlock as _, openBlock as c, createElementVNode as q, createCommentVNode as N, createVNode as h, withKeys as Ce, withCtx as f, createTextVNode as V, createBlock as v, unref as Fe, Fragment as F, renderList as I, renderSlot as Ie, withDirectives as le, vShow as ae, normalizeStyle as we, toDisplayString as w } from "vue";
...
const Te = { class: "advanced-search" }, $e = { class: "main-search-bar" }, Pe = { class: "filter-button-wrapper" }, De = { class: "advanced-search-form-popover" }, Oe = ["data-field"], qe = {
  ...
  setup(U, { emit: R }) {
    let b = null;
    const u = U, y = R, oe = A(null), C = A(!1), d = A(""), n = A({}), g = A([]), x = A({}), S = A({}), T = A({}), J = (e, a) => {
      const l = n.value[e];
    ...
    const W = O(() => u.searchConfig.formItems.length > 1), re = O(() => u.searchConfig.formItems.filter((e) => !e.hidden)), te = O(() => u.searchConfig.popoverWidth || 800), k = O(() => u.cacheKey ? `advancedSearch@${u.cacheKey}` : ""), ne = (e) => {
      ...
      if (e.type !== "select" && e.type !== "treeselect") return;
      const a = e;
      return async (l) => {
        if (a.remoteMethod) {
          T.value[e.field] = !0;
      ...
      try {
        ...
        if (e) {
          ...
          return l - a.timestamp > r ? (j(), null) : a.searchParams || null;
        }
      } catch (e) {
        console.warn("Failed to get search cache:", e), j();
      }
      return null;
    }, j = () => {
      if (k.value)
      ...
      for (const l of u.searchConfig.formItems)
        if (l.type === "custom")
          ...
          const r = l;
          n.value[l.field] = r.multiple ? [] : "";
        } else l.type === "textarea" ? (n.value[l.field] = l.default ?? "", e[l.field] = !1) : n.value[l.field] = l.default ?? "";
      x.value = e, g.value = [], j();
      const a = {};
    ...
    return ee(() => u.modelValue, (e) => {
      ...
      for (const t of u.searchConfig.formItems)
        if (t.type === "custom")
          ...
          const i = t;
          e[t.field] = i.multiple ? Array.isArray(t.default) ? t.default : [] : t.default ?? "";
        } else t.type === "daterange" ? e[t.field] = Array.isArray(t.default) ? t.default : [] : t.type === "numberrange" ? e[t.field] = Array.isArray(t.default) ? t.default : [null, null] : t.type === "textarea" ? (e[t.field] = t.default ?? "", a[t.field] = !1) : e[t.field] = t.default ?? "";
      n.value = e, x.value = a;
      const l = ce();
      ...
      const l = p("el-input"), r = p("el-button"), t = p("el-option"), i = p("el-select"), m = p("el-tree-select"), D = p("el-radio"), ye = p("el-radio-group"), be = p("el-checkbox"), ge = p("el-checkbox-group"), Y = p("el-date-picker"), K = p("el-input-number"), Z = p("el-form-item"), _e = p("el-col"), Ae = p("el-row"), Ve = p("el-popover"), Se = p("el-tag");
      return c(), _("div", Te, [
        q("div", $e, [
          h(l, {
            modelValue: d.value,
                ...
                q("div", De, [
                  h(Fe(Ue), {
                    ...
                    default: f(() => [
                      h(Ae, { gutter: 20 }, {
                        default: f(() => [
                          (c(!0), _(F, null, I(re.value, (o) => (c(), v(_e, {
                            key: o.field,
                              ...
                              h(Z, {
                                ...
                                default: f(() => [
                                  o.type === "input" || !o.type ? (c(), v(l, {
                                    ...
                                    style: we({ "--el-tree-select-dropdown-max-height": (o.maxDropdownHeight || 300) + "px" }),
                                    ...
                                    default: f(() => [
                                      (c(!0), _(F, null, I(o.options, (s) => (c(), v(D, {
                                        key: s.value,
                                        value: s.value,
                                    ...
                                    default: f(() => [
                                      (c(!0), _(F, null, I(o.options, (s) => (c(), v(be, {
                                        key: s.value,
                                        value: s.value,
                                  ...
                                  ])) : o.type === "custom" ? Ie(e.$slots, o.slotName || o.field, {
                                    key: 10,
                                    model: n.value,
                                    field: o.field
                                  }, void 0, !0) : N("", !0)
        ...
        g.value.length > 0 ? (c(), _("div", Ne, [
          (c(!0), _(F, null, I(g.value, (o) => (c(), v(Se, {
            key: o.key,
            closable: "",
            onClose: (s) => ve(o.key),
            class: "search-tag"
  ...
  for (const [u, y] of R)
    b[u] = y;
  return b;
}, Be = /* @__PURE__ */ je(Re, [["__scopeId", "data-v-ca879d08"]]);
export {
  Be as default
};
